export default function MacroTable() {
    ...
    return (
        <div
  className="relative flex flex-col overflow-scroll text-gray-700 bg-white shadow-md h-fit w-fit rounded-xl bg-clip-border">
  <table className="text-left table-auto w-fit">
