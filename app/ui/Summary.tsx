...
export function Summary({
    ...
    return (
        ...
        <section id="skideticaAppSummary">
            ...
            <div role="banner" className='flex flex-col h-fit min-w-screen rounded-[25px] lg:w-[300px] xl:w-[380px] border-primary md:py-6 pb-2 pt-4 shadow-md dark:shadow-md shadow-md_theme_dark_scrim bg-md_theme_light_surface_lowest dark:bg-md_theme_dark_surface_lowest'>
                ...
                <div className="flex px-5 lg:px-6 pb-8 text-left md:text-base text-sm lg:pb-6 md:pt-2">
                    <h1 className={' text-onBackground text-pretty tracking-wide'}>
                        <div className="flex flex-col space-y-4">
                            <div>
                                Compute the fair value of your favorite stock with Skidetica
                            </div>
                            <div>
